...
To add the CLA signing into your repository just copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/cla.yaml) into `.github/workflow` directory of your repository.
...
To add the prettier into your repository just copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/prettier.yaml) into `.github/workflow` directory of your repository.
...
To add the profanity filter into your repository just copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/profanity-filter.yaml) into `.github/workflow` directory of your repository.
...
Create a new workflow in your repository. Copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/automatic-pr-labeler.yaml) into `.github/workflow` directory of your repository.

#### Step 2: Add configuration file

Create a new configuration file `.github/auto-labeler-config.yaml`. Copy [prepared file](./docs/auto-labeler-config.yaml) into `.github` directory of your repository.
...
To add commit messages in pull request description into your repository copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/pr-collect-commit-messages.yaml) into `.github/workflow` directory of your repository.
...
To add the workflow into your repository copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/pr-conventional-commits.yaml) into `.github/workflow` directory of your repository.
...
To add the workflow into your repository copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/pr-lint-title.yaml) into `.github/workflow` directory of your repository.
...
Copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/maven-release.yaml) into `.github/workflow` directory of your repository.
...
Copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/python-release.yaml) into `.github/workflow` directory of your repository.
...
Copy the [prepared file](https://github.com/Netcracker/.github/workflow-templates/check-license.yaml) into `.github/workflow` directory of your repository.
